...
* **Training data:** use `plan-symbols --json` to export canonical `(serialized IR, symbolic plan)` records. Plans contain only `WORD_*`, `TERM_*`, `UNIT_*`, punctuation, `SPACE`/opaque whitespace, newline, and document-specific number symbols.
