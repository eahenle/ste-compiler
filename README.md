...
them as labeled controlled sentences (`Cause: ...; effect: ...`), and semantic validation checks
their direction, endpoint mappings, feature snapshot, and exact surface independently.
